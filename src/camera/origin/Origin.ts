...
export default class Origin extends Phaser.Scene
{
	private iter = 0
	private camera0!: Phaser.Cameras.Scene2D.Camera
	private camera1!: Phaser.Cameras.Scene2D.Camera
	private camera2!: Phaser.Cameras.Scene2D.Camera
	private camera3!: Phaser.Cameras.Scene2D.Camera
