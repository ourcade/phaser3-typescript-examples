...
export default class GameShaderTest3 extends Phaser.Scene
{
	...
	create()
	{
		...
		this.cameras.main.ignore(stars)
		this.cameras.main.ignore(platforms)

        const cam1 = this.cameras.main
        const cam2 = this.cameras.add(0, 0, 800, 600)
