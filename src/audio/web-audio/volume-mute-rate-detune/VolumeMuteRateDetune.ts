...
export default class VolumeMuteRateDetune extends Phaser.Scene
{
	...
	private soundLeft!: Phaser.Sound.WebAudioSound
	private soundRight!: Phaser.Sound.WebAudioSound
	...
	create()
	{
		...
		this.soundLeft = this.sound.add('left') as Phaser.Sound.WebAudioSound	
		this.soundRight = this.sound.add('right') as Phaser.Sound.WebAudioSound
