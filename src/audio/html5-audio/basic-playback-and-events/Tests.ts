const createTests = (first: Phaser.Sound.HTML5AudioSound, second: Phaser.Sound.HTML5AudioSound, audioSprite: Phaser.Sound.HTML5AudioSound, text: Phaser.GameObjects.Text, scene: Phaser.Scene) => {
	return [
		(fn: () => void) => {
			first.once('play', () => {
