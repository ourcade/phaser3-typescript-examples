...
export default class TextureAtlasAnimation extends Phaser.Scene
{
	preload()
	{
	...
	create()
	{
		...
		this.add.sprite(400, 300, 'seacreatures').play('jellyfish')
		this.add.sprite(550, 480, 'seacreatures').setOrigin(0).play('crab')
		this.add.sprite(730, 515, 'seacreatures').setScale(0.5).setOrigin(0).play('crab')
		this.add.sprite(100, 100, 'seacreatures').play('octopus')
		this.add.sprite(600, 200, 'seacreatures').play('purpleFish')
		this.add.sprite(100, 300, 'seacreatures').play('stingray')
